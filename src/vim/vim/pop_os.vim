...
" Base colors.
let s:colors.base0 = { 'gui': '#333333', 'cterm': 0 }
let s:colors.base1 = { 'gui': '#88807C', 'cterm': 8 }
let s:colors.base2 = { 'gui': '#73C48F', 'cterm': 10 }
let s:colors.base3 = { 'gui': '#48B9C7', 'cterm': 12 }
let s:colors.base4 = { 'gui': '#FFCE51', 'cterm': 11 }
let s:colors.base5 = { 'gui': '#34E2E2', 'cterm': 14 }
let s:colors.base6 = { 'gui': '#D3D7CF', 'cterm': 7 }
let s:colors.base7 = { 'gui': '#EEEEEC', 'cterm': 15 }

" Other colors.
let s:colors.red     = { 'gui': '#CC0000', 'cterm': 1  }
let s:colors.orange  = { 'gui': '#F15D22', 'cterm': 9  }
let s:colors.yellow  = { 'gui': '#C4A000', 'cterm': 3  }
let s:colors.magenta = { 'gui': '#AD7FA8', 'cterm': 13 }
let s:colors.violet  = { 'gui': '#75507B', 'cterm': 5  }
let s:colors.blue    = { 'gui': '#3465A4', 'cterm': 4  }
let s:colors.cyan    = { 'gui': '#06989A', 'cterm': 6  }
let s:colors.green   = { 'gui': '#58946D', 'cterm': 2  }
...
call s:Col('htmlTag', 'base2')
call s:Col('htmlTagName', 'base2')
call s:Col('htmlEndTag', 'base2')
call s:Col('htmlString', 'cyan')
call s:Col('htmlArg', 'base5')
